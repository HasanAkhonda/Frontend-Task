<script lang="ts">
  ...
  import BioGeneratorLayout from "../../sub-components/BioGeneratorLayout.svelte";
  import FormCard from "../../sub-components/FormCard.svelte";
  import EditorCard from "../../sub-components/EditorCard.svelte";
...
<BioGeneratorLayout {showSecondCard}>
  ...
  <!-- Editor Card Slot will come while Generating Response -->
  <EditorCard slot="editor" {showSecondCard} {loadingAI} {editorContent} />
</BioGeneratorLayout>
